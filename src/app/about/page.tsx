      ...
      <div className="px-32">
        <section className="mt-16 bg-brand  border-none rounded-3xl">
          <div className="px-10 pt-[10rem] pb-[5rem]">
            ...
            <p className="py-6 text-white text-base font-cocogoose-light">
        ...
        <section className="mt-20">
          ...
          <div className="flex pt-6 justify-center gap-1">
            <div className="flex flex-col gap-2">
              ...
              <span className="bg-light-blue-30 text-brand font-cocogoose-light text-base leading-3 flex justify-center h-[50px] rounded-xl w-[20rem] px-2 items-center">
                Not in Education,
                <br />
                Employment, or Training.
              </span>
              <span className="bg-light-blue-30 text-brand font-cocogoose-light text-base flex justify-center h-[50px] rounded-xl w-[20rem] items-center">
                Students.
              </span>
            </div>
            <div className="flex flex-col gap-2">
              ...
              <span className="bg-light-blue-30 text-brand text-base font-cocogoose-light flex justify-center h-[50px] rounded-xl w-[20rem] px-2 items-center">
                Educators.
              </span>
              <span className="bg-light-blue-30 text-brand text-base font-cocogoose-light flex justify-center h-[50px] rounded-xl w-[20rem] items-center">
                Teachers.
              </span>
              <span className="bg-light-blue-30 text-brand text-base font-cocogoose-light flex justify-center h-[50px] rounded-xl w-[20rem] items-center">
                Youth leaders.
            ...
            <div className="flex flex-col gap-2">
              ...
              <span className="bg-light-blue-30 text-brand text-base font-cocogoose-light leading-3 flex justify-center h-[50px] rounded-xl w-[20rem] items-center">
        ...
        <section className="mt-20">
          ...
          <p className="text-center text-black font-cocogoose-light text-base pt-4">
          ...
          <div className="flex justify-center pt-12">
            <div className="flex flex-col gap-12">
              <div className="flex gap-8">
                ...
                <p className="text-base font-cocogoose-light text-black  w-[60%]">
        ...
        <section className="mt-16 bg-light-blue-30 text-brand border-none rounded-3xl">
          <div className="pl-10 py-[2rem]">
            ...
            <div className="pt-5 pb-8">
              ...
              <li className="list-none text-base font-cocogoose-light">
        ...
        <section className="mt-16 bg-brand border-none rounded-3xl">
          <div className="pl-10 py-[2rem]">
            ...
            <div className="pt-8">
              ...
              <p className="text-base font-cocogoose-light text-white py-2">
                Associação VR de Marketing
              </p>
              <p className="text-base font-cocogoose-light text-white w-[70%] pb-8">
