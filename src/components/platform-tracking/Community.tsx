...
const Community = () => {
  const [
    openedCreateCommunity,
    { open: openCreateCommunity, close: closeCreateCommunity },
  ] = useDisclosure(false);
        ...
        <div className="w-[30%] md:w-full">
          <div className="border-none shadow-lg rounded-lg px-6 py-6">
                ...
                <div key={topic.id}>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-lg font-cocogoose cursor-pointer">
                        {topic.name}
                      </span>
                    </div>
            ...
            <div className="mt-5 flex flex-col items-center">
              <button onClick={openCreateCommunity} className="bg-brand text-white text-base rounded-lg justify-center px-14 h-10 items-center">
                Create Channel
              </button>
            </div>
          </div>
