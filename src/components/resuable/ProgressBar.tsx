...
const ProgressBar: FC<iProgressBarProps> = ({
  ...
  return (
    <div
      className={`${
        removeMargin !== undefined && removeMargin ? "my-0" : "my-5"
      } ${
    ...
    >
      ...
      <p
        className={`absolute ${
          height !== undefined ? "top-5" : "top-2"
        } w-full flex gap-2 items-center justify-center text-white font-cocogoose text-[18px] md:text-[14px]`}
      >
